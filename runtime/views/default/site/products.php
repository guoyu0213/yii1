	...
	<div class="summary">
		...
		<?php }else{?>
			...
			<dl class="m_10 clearfix">
				...
				<dd class="w_45">
					<?php foreach($item['value'] as $specValueKey => $spec_value){?>
					<?php list($item['tip'],$item['value'])=each($spec_value);?>
					<?php if($item['type'] == 1){?>

					<!--文字规格 开始-->
					<div class="item w_27">
						<a href="javascript:void(0);" specId="<?php echo isset($item['id'])?$item['id']:"";?>" id="<?php echo isset($item['id'])?$item['id']:"";?><?php echo isset($specValueKey)?$specValueKey:"";?>" title="<?php echo htmlspecialchars($item['tip']);?>"><?php echo isset($item['value'])?$item['value']:"";?><span></span></a>
					</div>
					<!--文字规格 结束-->
					...
					<!--图片规格 开始-->
					<div class="item">
						<a href="javascript:void(0);" specId="<?php echo isset($item['id'])?$item['id']:"";?>" id="<?php echo isset($item['id'])?$item['id']:"";?><?php echo isset($specValueKey)?$specValueKey:"";?>" title="<?php echo htmlspecialchars($item['tip']);?>" style="background:url(<?php echo IUrl::creatUrl("".$item['value']."");?>) center no-repeat;background-size:contain;height:40px;display:inline-block;"><span></span></a>
					</div>
					<!--图片规格 结束-->
	...
	<div class="main f_r" style="overflow:hidden">
		...
		<div name="showBox">
			...
			<div>
				...
				<?php if(isset($video_path) && $video_path){?>
					<video id="myVideo" width="720" height="340" controls poster="./video/14763290868422.jpg">
    					<source src="<?php echo isset($video_path)?$video_path:"";?>" type="video/mp4">
					</video>
				<?php }?>
			</div>
			<!-- 商品详情 end -->
					...
					<div class="user">
						<div class="ico">
							<a href="javascript:void(0)">
								<img src="<%=webroot(head_ico)%>" width="70px" height="70px" onerror="this.src='<?php echo $this->getWebSkinPath()."images/front/user_ico.gif";?>'" />
							</a>
						</div>
			...
			<div class="hidden comment_list box">
				...
				<div class="item">
					<div class="user">
						<div class="ico"><img src="<%=webroot(head_ico)%>" width="70px" height="70px" onerror="this.src='<?php echo $this->getWebSkinPath()."images/front/user_ico.gif";?>'" /></div>
						<span class="blue"><%=username%></span>
					</div>
					<dl class="desc gray">
						<p>
