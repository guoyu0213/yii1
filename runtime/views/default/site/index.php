...
<div class="container">
	...
	<?php echo Ad::show("页面顶部通栏广告条960*70(default)");?>
		...
		<div class="group_on box m_10">
			...
			<div class="cont">
				<ul class="ranklist">
					...
					<li class="current">
						<a href="<?php echo IUrl::creatUrl("/site/groupon/id/".$item['id']."");?>"><img width="60px" height="60px" alt="<?php echo isset($item['title'])?$item['title']:"";?>" src="<?php echo IUrl::creatUrl("")."".$item['img']."";?>"></a>
						<a class="p_name" title="<?php echo isset($item['title'])?$item['title']:"";?>" href="<?php echo IUrl::creatUrl("/site/groupon/id/".$item['id']."");?>"><?php echo isset($item['title'])?$item['title']:"";?></a><p class="light_gray">团购价：<em>￥<?php echo isset($item['regiment_price'])?$item['regiment_price']:"";?></em></p>
					</li>
					<?php }?>
			...
			<div class="cont clearfix">
				<ul class="prolist">
					...
					<li>
						...
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."/promo/time/active_id/".$item['p_id']."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/175/h/175");?>" width="175" height="175" alt="<?php echo isset($item['name'])?$item['name']:"";?>" title="<?php echo isset($item['name'])?$item['name']:"";?>" /></a>
						<p class="pro_title"><a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."/promo/time/active_id/".$item['p_id']."");?>"><?php echo isset($item['name'])?$item['name']:"";?></a></p>
		...
		<div class="hot box m_10">
			...
			<div class="cont clearfix">
				<ul class="prolist">
					...
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['id']."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/85/h/85");?>" width="85" height="85" alt="<?php echo isset($item['name'])?$item['name']:"";?>" /></a>
	...
	<div class="main f_l">
		...
		<div class="brand box m_10">
			...
			<div class="cont clearfix">
				<ul>
					...
					<li><a href="<?php echo IUrl::creatUrl("/site/brand_zone/id/".$item['id']."");?>"><img src="<?php echo IUrl::creatUrl("")."".$item['logo']."";?>"  width="110" height="50"/><?php echo isset($item['name'])?$item['name']:"";?></a></li>
					<?php }?>
				</ul>
			</div>
		</div>
		...
		<div class="comment box m_10">
			...
			<div class="cont clearfix">
				...
				<dl class="no_bg">
					<dt><a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>"><img src="<?php echo IUrl::creatUrl("/pic/thumb/img/".$item['img']."/w/66/h/66");?>" width="66" height="66" /></a></dt>
					<dd><a href="<?php echo IUrl::creatUrl("/site/products/id/".$item['goods_id']."");?>"><?php echo isset($item['name'])?$item['name']:"";?></a></dd>
