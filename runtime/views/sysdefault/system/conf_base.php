	...
	<div class="content form_content">
		...
		<form action='<?php echo IUrl::creatUrl("/system/save_conf/form_index/other_conf");?>' method='post' name='other_conf'>
			<table class="form_table">
				...
				<tr>
					<th>物流系统商户ID：</th>
					<td><input type='text' name='freightid' class='normal' /><label>免费物流接口，<a href="http://bbs.aircheng.com/read-2400" target="_blank">帮助说明</a></label></td>
				</tr>
				<tr>
					<th>物流系统ApiKey：</th>
					<td><input type='text' name='freightkey' class='normal' /></td>
				</tr>
				<tr>
					<th></th>
					<td>
