...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
	<div class="position"><span>商品</span><span>></span><span>规格管理</span><span>></span><span>规格图库</span></div>
	<div class="operating">
		<a href="javascript:void(0)" onclick="selectAll('id[]');"><button class="operating_btn" type="button"><span class="sel_all">全选</span></button></a>
		<a href="javascript:void(0)" onclick="confirm('确定删除么？','formSubmit(\'specFrom\')');"><button class="operating_btn" type="button"><span class="delete">批量删除</span></button></a>
	</div>
</div>
<div class="content">
	<form action='<?php echo IUrl::creatUrl("/goods/spec_photo_del");?>' method='post' name="specFrom">
		<table class="list_table" cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<?php $query = new IQuery("spec_photo");$query->page = "$page";$query->pagesize = "20";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
					<td><input type="checkbox" name="id[]" value="<?php echo isset($item['id'])?$item['id']:"";?>" /></td>
					<td><img class="spec_photo" src="<?php echo IUrl::creatUrl("".$item['address']."");?>" /></td>
