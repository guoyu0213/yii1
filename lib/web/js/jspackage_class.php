...
class IJSPackage
{
	...
	{
		return '<script>jQuery(function(){$("img[data-src]").lazyload({threshold :210,failurelimit:12,effect:"fadeIn"});});</script>';
	}
}